<main>
    <section style="padding: 40px 0;">
        <div class="container">
            ...
            <p style="text-align: center;">Rapat: <strong><?= $data['rapat']['judul_rapat']; ?></strong></p>

            <form action="<?= BASEURL; ?>/rapat/processAbsensi" method="POST" enctype="multipart/form-data" class="neu-card" style="margin-top: 20px;">
                ...
                <div style="text-align: right; margin-top: 20px;">
                    <a href="<?= BASEURL; ?>/rapat/detail/<?= $data['rapat']['id_rapat']; ?>" class="neu-btn btn-secondary">Batal</a>
