...
<body>
    ...
    <main>
        <section class="dashboard-section">
            <div class="container">
                ...
                <a href="buat-rapat.html" class="new-meeting-btn-link">
    ...
    <div class="meeting-item neumorphic-item status-terjadwal">
        <div class="meeting-details">
            <span class="meeting-status-tag">Terjadwal</span>
            <a href="detail-rapat.html?id=106" class="meeting-title">Review Proyek Pengembangan Sipera v2.0</a>
    ...
    <div class="meeting-item neumorphic-item status-dibatalkan">
        <div class="meeting-details">
            ...
            <a href="detail-rapat.html?id=107" class="meeting-title">Rencana Pembukaan Prodi Baru (Dibatalkan)</a>
            <p class="meeting-info">🗓️ 01 Nov 2025 | 🕘 10:00 WIB | 📍 Ruang Rapat Direktur</p>
        </div>
        <div class="meeting-actions">
            <a href="edit-rapat.html?id=107" class="action-btn btn-edit-link">📝 Lihat Detail</a>
...
<div id="rapat-selesai" class="tab-content">
    <div class="meeting-item neumorphic-item status-selesai">
        <div class="meeting-details">
            ...
            <a href="detail-rapat.html?id=108" class="meeting-title">Pengumuman Perubahan Jadwal Semester</a>
            <p class="meeting-info">🗓️ 15 Des 2025 | 🕘 10:00 WIB | 📍 Auditorium</p>
        </div>
        <div class="meeting-actions">
            <a href="detail-rapat.html?id=108" class="action-btn btn-view-link">👀 Detail</a>
        </div>
    </div>
</div>
